  ...
  return (
    <div>
        ...
        <div className="flex items-center gap-4 mt-3">
            ...
            <button className="w-8 h-8 flex items-center justify-center rounded border border-[#7321A6] hover:bg-[#7321A6]" 
            onClick={()=>  {
                addNewTag();
            }} >
                <MdAdd className="text-2xl text-[#7321A6] hover:text-white" /> 
            </button>
        </div>
    </div>
  );
